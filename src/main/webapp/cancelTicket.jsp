...
<html>
	...
	<body>
		...
		<form name="cancelationForm" method="POST" action="cT.jsp">
            <p>Ticket ID: <input type="text" name="ticketID" size="20"/></p>
			<p>No. of Passengers : <input type="text" size="20" name="noOfTkts"/></p>
